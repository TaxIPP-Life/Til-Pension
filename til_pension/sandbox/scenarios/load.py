...
from til_pension.sandbox.scenarios.CONFIG_scenarios import data_scenarios_path
...
def load_case(i):
    file = os.path.join(data_scenarios_path, 'data' + str(i) + '.csv')
    ...
    if not all((data['remu_pub'] == 0) | (data['remu_priv'] == 0)):  # TODO: remove
...
for i in range(nb_scenarios):
    ...
    info_ind.loc[
        ...
        ] = [sexe, nb_enf, nb_enf, nb_enf, nb_enf, nb_enf]
