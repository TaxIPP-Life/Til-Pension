...
from utils_pension import build_salref_bareme, print_multi_info_numpy, _info_numpy
...
class RegimeSocialIndependants(RegimePrive):
    ...
    def get_trimesters_wages(self, data):
        ...
        trimesters['cot'], _ = validation_trimestre(reduce_data, self.code_regime, salref, name='cot')
